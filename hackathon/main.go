...
func main() {
	...
	mux.HandleFunc("/user", userHandlers.UserGetHandler)              // GET /user?name=...or?email=...or?id=...
	...
	mux.HandleFunc("/posts", postHandlers.PostsGetHandler)            // GET /posts(?email=...or?userid=...)
